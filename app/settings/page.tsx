		...
		<div className="p-6 space-y-6">
			<div className="flex items-center justify-between">
				<div>
					...
					<p className="text-muted-foreground">ปรับแต่งการแสดงผลและการใช้งานระบบ</p>
				</div>
			...
			<div className="grid gap-6 md:grid-cols-2">
				...
				<Card>
					<CardHeader>
						...
						<CardDescription>เลือกธีมการแสดงผลที่คุณต้องการ</CardDescription>
					</CardHeader>
				...
				<Card>
					<CardHeader>
						...
						<CardDescription>ปรับขนาดตัวอักษรให้เหมาะสมกับการใช้งาน</CardDescription>
					</CardHeader>
					<CardContent className="space-y-6">
						<div className="space-y-3">
				...
				<Card>
					<CardHeader>
						...
						<CardDescription>เลือกภาษาที่ใช้ในระบบ</CardDescription>
					</CardHeader>
					<CardContent>
						<div className="space-y-3">
			...
			<Card>
				<CardHeader>
					...
					<CardDescription>การตั้งค่าเพิ่มเติมสำหรับการใช้งาน</CardDescription>
				</CardHeader>
				<CardContent className="space-y-4">
					<div className="flex items-center justify-between">
						<div>
					...
					<div className="flex items-center justify-between">
						<div>
							...
							<p className="text-sm text-muted-foreground">
								ลดขนาดรูปภาพที่อัปโหลดเพื่อประหยัดพื้นที่
							</p>
						</div>
						<Switch defaultChecked />
					</div>
